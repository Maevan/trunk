...
public class IPSeeker {
    ...
    public static void main(String[] args) {
        try {
            IPSeeker ipSeeker = new IPSeeker(new File(Thread.currentThread().getContextClassLoader().getResource("net/ipsearch/data/qqwry.dat").getFile()));
            System.out.println(ipSeeker.getAddress("61.135.169.125"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
